...
#          "agent_name":"Generic"}
# response=cl.get_documents()
# print(response)

# # print(cl.create_session("session156",'admin'))
# # cl.save_message(message)
# # print(cl.get_chat_history("session123"))
# # #print(cl.get_sessions(user_id="admin"))
# # print(cl.clear_chatmessages("session123"))
# # print(cl.get_chat_history("session123"))
...
data={
    ...
    "password":"1231gdhapassword",
    "email_id":'17287178&email',
    "logged_in":None,
    "last_logged_in":None
}
# r,a=cl.create_user(user_data=data)
# print(r,a)

...
mcp = FastMCP("MCP server", include_fastmcp_meta=False)
...
def embed_search(query,limit):
    from app.services.query_embeddings import query_embedding
    from app.services.qdrant_retrevial import Qdrantservice
